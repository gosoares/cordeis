...
% Redefine the pagebreak command to properly handle the <!-- pagebreak --> comments
\AtBeginDocument{
...
% No need for title formatting commands, we'll handle it directly
% in the template using variables
...
% Cover page
\thispagestyle{empty}
\includepdf[pages=1, noautoscale=true, width=\paperwidth, height=\paperheight]{$cover$}
